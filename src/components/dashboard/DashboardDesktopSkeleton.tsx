...
export function DashboardDesktopSkeleton() {
  return (
    <div
      className="rounded-xl border border-foreground/[0.06] bg-foreground/[0.012] overflow-hidden animate-fade-in"
      aria-busy="true"
    ...
    >
      ...
      <div className="flex border-t border-foreground/[0.05]">
        {Array.from({ length: 6 }, (_, i) => (
          <div key={i} className="flex-1 px-5 py-4 border-l border-foreground/[0.05] first:border-l-0">
      ...
      <div className="grid lg:grid-cols-[1fr_minmax(280px,360px)] border-t border-foreground/[0.05]">
        <div className="p-6 border-b border-foreground/[0.05] lg:border-b-0 lg:border-r">
